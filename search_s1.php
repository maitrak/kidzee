...
<?php
	...
	echo $studid=$_GET['userid'];
		...
		`E2__rela`, `DOC_name`, `DOC_add`, `DOC_pin`,`DOC_phone`, `DOC_mobile`, `DOC_email`, `allergies`, `allergies_discp`, `issue`,
		`issue_discp`, `medication`, `medication_discp`, `understand`, `comment`, `Batch_detail`, `timing`, `date`,
		`invoice`, `amount`,`pdf1`,`pdf2`,`pdf3` FROM `register` WHERE `child_Id`='$studid'";
				...
				if(mysqli_num_rows($result)!=0)
    {
		...
		$m="http://localhost/kidzee/Image/";
			...
			echo "</tr>";
			echo "<tr>";
			echo "<tr><td>File 1</td><td><a href='http://localhost/kidzee1/child_doc/<?php echo $row[129]; ?>' >File</a></td></tr>";
			echo "<tr><td>File 2</td><td><a href='http://localhost/kidzee1/child_doc/<?php echo $row[130]; ?>' >File</a></td></tr>";
			echo "<tr><td>File 3</td><td><a href='http://localhost/kidzee1/child_doc/<?php echo $row[131]; ?>' >File</a></td>";
