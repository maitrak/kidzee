...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/kidzee/bootstrap.min.css">
  <link href="http://localhost/kidzee/css.css" rel="stylesheet" type="text/css">
  <link href="http://localhost/kidzee/css1.css" rel="stylesheet" type="text/css">
  <script src="http://localhost/kidzee/jquery.min.js"></script>
  <script src="http://localhost/kidzee/bootstrap.min.js"></script>
  <style>
  body {
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#pricing">Step 2 -3</a></li>
  ...
  <div class="row">
    <div class="col-sm-8">
      ...
      <h4>Kids Eduworld India came into existence in 2018 with the objective of contribution towards building New India in its own way by shaping primitive years of the child towards strong foundation.<br>
		...
		Kids Eduworld India celebrates its foundation day with new Awtar on 29th September 2019.<br></h4>
            <br>
    </div>
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="PTP.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>  	
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Nursery.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>      	
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Jr.Kg.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>      	
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Sr.Kg.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>     
    <div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Day_Care.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div> 
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="excel_Inward_Register.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>
	<div class="col-sm-3 col-xs-12">
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="excel_Outward_Register.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div> 
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Petty_cash_view.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>     
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Payment_view.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div> 
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="R_view.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>
		<div class="col-sm-3 col-xs-12">
	...
	<div class="col-sm-3 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <a href="Notice_view.php"><button class="btn btn-lg">Enter</button></a>
        </div>
      </div>      
    </div>
