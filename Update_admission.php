...
<?php
    ...
    if(isset($_POST['submit']))
    {
		...
		<h1> Update Admission/Fee Details</h1>
...
<option value="YES" <?php if($row['uniform'] == "YES") { echo "selected"; }?>>YES</option>
  ...
  <input type="text" id="Addr" name="Addr" style="width:1300px;" value="<?php echo $row[122];?>"><br>
  ...
  <input type="text" id="pending" name="pending" value="<?php echo $pending;?>"><br>
   <input type="submit" name="update" value="update"><br> 
	<p>Update Twice When Updating Any Fees Data
	</p>
  </form>
  <a href="http://localhost/kidzee/Update_admission.php"><button>Cancel</button></a>
		<?php
		}
	}
	else
