...
<form method="post">
	...
	Enter Subject &nbsp&nbsp<input type="text" name="subject" required>
	Enter Body &nbsp&nbsp<input type="text" name="body" required>
...
<?php
		...
		if(mysqli_num_rows($result)!=0)
    {
		...
		$m="http://localhost/kidzee/Image/";
			...
			$mail->AddAddress($row['M_Email']);
			$mail->AddAddress($row['F_Email']);
			$mail->SetFrom("maitrak523@gmail");
