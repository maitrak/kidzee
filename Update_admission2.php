...
<?php
    ...
    if(isset($_GET['addid']))
    {
		...
		<h1> Update Admission/Fees Details</h1>
...
<label >Class</label> 
  ...
  <option value="NEFT/IMPS" <?php if($row[9] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <b><label >Stake Rate Fee</label></b>
  ...
  <option value="NEFT/IMPS" <?php if($row[23] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[29] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[35] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[41] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[47] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[53] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[59] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[65] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[71] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[77] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row[83] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row['mode12'] == "NEFT/IMPS") { echo "selected"; }?>>NEFT</option>
  ...
  <option value="NEFT/IMPS" <?php if($row['chq_onl'] == "NEFT") { echo "selected"; }?>>NEFT</option>
...
<option value="YES" <?php if($row['uniform'] == "YES") { echo "selected"; }?>>YES</option>
  ...
  <a href="pending.php"><button>Cancel</button></a>
		<?php
		}
	}
	else
